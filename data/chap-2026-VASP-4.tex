...
\url{https://vasp.at/tutorials/latest/}，这个教程在一直在维护和更新。笔者以为这是迄今为止最完整的\textrm{VASP}教程，除了对各算例有比较详细的输入、输出内容的说明，包括编译、安装及执行在内，都有详细的指导，有兴趣的\textrm{VASP}用户，特别是初学者，建议遵照教程尝试练习。本章也将参照教程的算例，对\textrm{VASP}具体计算中的内容作必要说明。
\section{基本计算}
