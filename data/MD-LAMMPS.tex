...
\textrm{Excel}绘出结果来获得平衡晶格常数、内聚能和体积模量。图\ref{MD_5-atoms}显示了$E\text{-}a$曲线，这是由四阶多项式拟合的铝晶格参数的函数。根据拟合曲线，我们得出$a_0=4.05\AA$，$E_{\mathrm{coh}}=3.37~\mathrm{eV/atom}$，分别与实验结果$4.05~\AA$和$3.39~\mathrm{eV/atom}$（Gaudoine等人2002）非常吻合。
