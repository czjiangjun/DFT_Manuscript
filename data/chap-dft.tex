...
对%于})
均匀电子气的相关能并没有统一\linebreak 的解析式。von Barth\cite{JPC5-1629_1972}和Gunnarsson\cite{PRB13-4274_1976}等人都提出过一些近似的式子。1980年Ceperley和Alder\cite{PRL45-566_1980}曾用量子\textrm{Monte Carlo}方法计算得到的均匀电子气相关能的数据， 同年，Vosko、Wilk和Nusair\cite{CJP58-1200_1980}利用这些数据拟合出了一个%1980年，\linebreak Vosko、Wilk和Nusair\cite{CJP58-1200_1980}利用Ceperley和Alder\cite{PRL45-566_1980}用量子Monte Carlo方法计算得到的{均匀电子气}相关能数据拟合出一个%均匀电子气的})
相关能的%公})
{表达}式，即最常用的VWN%公})
...
按照Perdew的建议\cite{Perdew-Schmit_2001}，现有的交换-相关能密度泛函可以分为以下几类：
\begin{enumerate}
...
用这种近似泛函计算的原子基态能量，就会出现因所选简并原子轨道电子密度不同而结果不同的问题\cite{PRB43-6865_1991,CPL265-481_1997}，
给计算分子体系的原子化能造成很大%的})
