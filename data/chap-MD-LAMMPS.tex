...
根据图\ref{LAMMPS-Graphene-roll}的结果，可以计算出S\textsubscript{w}和E分别为$51~\mathrm{eV}$和$92~\textrm{nm}^2$。根据式\eqref{eq:H2O-surface-tension}，计算出的水表面张力为$88.64~\mathrm{mN/m}$（或$0.554~\mathrm{eV/nm}^2$），与实验值$75~\mathrm{mN/m}$\textcolor{red}{（Wikipedia 2010）}基本吻合。
