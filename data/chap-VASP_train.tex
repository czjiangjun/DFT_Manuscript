...
找到$z$-方向的势函数数据，并用合适的脚本，比如\textrm{Python}脚本如\textcolor{blue}{\textrm{locpot\_workfunc.py}}\footnote{该软件由韩国汉城大学\textrm{Jinwoo,Park,Lanhee Yang}开发\cite{Park-Yang}}转成$\ast\mathrm{.dat}$格式的文件，运行命令为:\\
...
\begin{figure}[h!]
\centering
\includegraphics[height=1.8in,viewport=0 0 700 200,clip]{Pt_NEB-INCAR.png}
%\includegraphics[height=1.8in,width=4.in,viewport=30 210 570 440,clip]{PAW_projector.eps}
...
\begin{figure}[h!]
\centering
\includegraphics[height=2.5in,viewport=0 20 300 200,clip]{Pt_NEB-VTST-1.png}
%\includegraphics[height=1.8in,width=4.in,viewport=30 210 570 440,clip]{PAW_projector.eps}
...
\begin{figure}[h!]
\centering
\includegraphics[height=3.5in,viewport=0 0 790 630,clip]{Pt_NEB-reaction.png}
%\includegraphics[height=1.8in,width=4.in,viewport=30 210 570 440,clip]{PAW_projector.eps}
