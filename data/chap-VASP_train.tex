...
有了这些声子计算的基本数据，就可以通过计算从理论上估计晶体的熵、自由能和热膨胀等热力学物性数据。当然，这些内容已经超出本讲义的范围，兹不赘言。此外，关于\textrm{VASP}计算材料的光学和介电函数性质、\textit{GW}校正的计算参数设置和相关内容，有兴趣的读者可以参阅:~\url{http://cms.mpi.univie.ac.at/wiki/index.php}
