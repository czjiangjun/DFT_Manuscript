...
\chapter{量子计算}\label{chap:quantum-calculation}
...
\subsection{投影子缀加波(Projector Augmented Wave, PAW)方法}
...
\subsection{线性缀加平面波(Linear Augmented Plane Wave, LAPW)方法}
